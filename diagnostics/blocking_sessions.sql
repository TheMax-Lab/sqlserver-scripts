...
Description:      Identifies currently blocked requests in the selected  
                  database and reports their direct blocking session.  
Author:           TheMaxLab  
Version:          1.0  
License:          MIT  
...
Notes:  
  - The script reports direct blockers, not only the root blocker.  
  - Negative blocking_session_id values identify special/internal owners.  
*******************************************************************************/  
