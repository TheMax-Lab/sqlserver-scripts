...
SELECT  
    ...
    CONCAT(  
        QUOTENAME(DB_NAME()), '.',  
        QUOTENAME(af.[logical_name] COLLATE DATABASE_DEFAULT)  
    ) AS [Object],  
    ...
    CONCAT(  
        ...
        '; file type=',  
        af.[file_type_desc] COLLATE DATABASE_DEFAULT,  
        '; state=',  
        af.[state_desc] COLLATE DATABASE_DEFAULT,  
        '; file size MB=',  
        af.[size_mb],  
    ...
    CASE  
        ...
        THEN CONCAT(  
                ...
                QUOTENAME(DB_NAME()),  
                ' MODIFY FILE (NAME = N''',  
                REPLACE(af.[logical_name] COLLATE DATABASE_DEFAULT, '''', ''''''),  
                ''', FILEGROWTH = ',  
                CASE  
